...
public class NewsController {
    ...
    public String newsDetail(@PathVariable("newsId") int newsId, Model model) {
        try {
            ...
            if (news != null) {
                List<Comment> comments = commentService.getCommentsByEntity(news.getId(), EntityType.ENTITY_NEWS);//int entityId, int entityType
    ...
    public void getImage(@RequestParam("name") String imageName,
        ...
        try {
            ...
            StreamUtils.copy(new FileInputStream(new  //本地的图片获取
    ...
    @ResponseBody
    public String uploadImage(@RequestParam("file") MultipartFile file) {  //上传二进制流
        try {
