...
public class MessageController {
    ...
    public String conversationList(Model model) {//此处知道用户是谁，不需要注入参数
        try {
            ...
            for (Message msg : conversationList) {
                ...
                int targetId = msg.getFromId() == localUserId ? msg.getToId() : msg.getFromId();//得到交互人的信息id
